...
class SetValueXMWidget extends StatefulWidget {
  final CryptoInfo crypto;
  final Alert alert;
  final NotificationCrypto? notification;
  const SetValueXMWidget(
      {super.key,
  ...
  @override
  State<SetValueXMWidget> createState() => _SetValueXMWidgetState();
}

class _SetValueXMWidgetState extends State<SetValueXMWidget> {
