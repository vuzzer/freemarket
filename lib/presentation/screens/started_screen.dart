...
class _StartedScreenState extends State<StartedScreen> {
  final internetCheckerStream =
      sl<NetworkInfo>().listener;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:  StreamBuilder(
        stream: internetCheckerStream.distinct(),
        builder: (context, snapshot) {
          ...
          if ((status == InternetConnectionStatus.connected)) {
            ...
            return  Center(child: Text("Pas de connexion internet", style: Theme.of(context).textTheme.displayMedium,));
          }
        }));
  }
}
